#!/usr/bin/env python3
# -------- advanced_extractor.py (v16.1 – patched, stable) --------
"""
Clinical‑Trial Outcome Extractor
Patch notes v16.1
• Fixed all unterminated triple‑quoted strings / parentheses
• Normalised variable names (export_df)
• Ensured expanders are not nested
• Minor style & reliability tweaks (flake8 / ruff clean)
"""
...
st.set_page_config(layout="wide", page_title="Clinical Trial Outcome Extractor v16.1")
st.title("Clinical‑Trial Outcome Extractor (v16.1)")
st.markdown(
